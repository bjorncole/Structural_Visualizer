...
public class NassiShneidermanWhileBlock extends NassiShneidermanBlock {
	
	public NassiShneidermanWhileBlock() {
		blockHeight = 50;
		blockWidth = 20;
		headerHeight = 50;
		headerWidth = 400;
	...
	public String renderBlock() {
		...
		drawingString.append("\t\theight=\"" + ((Integer) (blockHeight - headerHeight)).toString() + "\"\n");
		drawingString.append("\t\tx=\"" + ((Integer) (blockStartHorizontal + headerHeight)).toString() + "\"\n");
	...
	public Integer getBodyHeight() {
		return blockHeight - headerHeight;
	}
	
	public String toString() {
		return "While block (height, width) = [" + blockHeight + ", " + blockWidth + "], " +
