...
public class NassiShneidermanExprBlock extends NassiShneidermanBlock {
	
	public NassiShneidermanExprBlock() {
		blockHeight = 50;
		blockWidth = 20;
		headerHeight = 50;
		headerWidth = 400;
	...
	public String renderBlock() {
		...
		drawingString.append("\t\twidth=\"" + ((Integer) getBodyWidth()).toString() + "\"\n");
		drawingString.append("\t\theight=\"" + ((Integer) getBodyHeight()).toString() + "\"\n");
		drawingString.append("\t\tx=\"" + ((Integer) getBodyStartX()).toString() + "\"\n");
	...
	public String toString() {
		return "Expression block (height, width) = [" + blockHeight + ", " + blockWidth + "], " +
